      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12 ">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-xl  text-white dark:text-slate-400">In hac habitasse platea
              dictumst
            </p>
          </div>
        </div>
            ...
            <div className="h-full pr-6">
              ...
              <ul className="mb-6 md:mb-0">
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    <h3 className="mb-2 text-lg font-medium leading-6 text-white dark:text-white">Working
                      hours</h3>
