...
const MobileMenu: React.FC = () => {
    const [isBlogDropdownVisible, setBlogDropdownVisible] = useState(false);

    const toggleBlogDropdown = () => {
        setBlogDropdownVisible((prev) => !prev);
    };
            ...
            <AnimatePresence>
                ...
                >
                    <ol className="space-y-5 pl-32">
                        ...
                        <li
                            className="flex space-x-2 items-center hover:text-blue-600 cursor-pointer"
                        ...
                        >
                            <svg
                                ...
                                fill="#e8eaed"
                            >
                                <path d="M160-120q-33 0-56.5-23.5T80-200v-640l67 67 66-67 67 67 67-67 66 67 67-67 67 67 66-67 67 67 67-67v640q0 33-23.5 56.5T800-120H160Zm0-80h280v-240H160v240Zm360 0h280v-80H520v80Zm0-160h280v-80H520v80ZM160-520h640v-120H160v120Z" />
                            </svg>
                            <span>Blogs</span>
                        </li>
                        {isBlogDropdownVisible && (
                            <ul className="pl-10 space-y-3">
                                ...
                                <li className="flex space-x-2 items-center hover:text-blue-600">
                                    ...
                                    <a href="/blogs/other-news">Other News</a>
                                </li>
                            </ul>
                        )}
                        <li className="flex space-x-2 items-center hover:text-blue-600">
